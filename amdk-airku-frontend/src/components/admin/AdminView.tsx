...
export const AdminView: React.FC = () => {
                ...
                {navItems.map(item => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center space-x-3 px-6 py-3 text-left transition duration-200 ${isActive
                                ? 'bg-brand-primary'
    ...
    return (
        <div className="flex min-h-screen bg-brand-background">
            {/* Desktop Sidebar */}
            <aside className="hidden md:flex w-64 bg-brand-dark text-white flex-col flex-shrink-0 sticky top-0 h-screen overflow-y-auto" style={{ backgroundColor: '#03045E' }}>
                {sidebarContent}
            </aside>
