...
export const DriverView: React.FC = () => {
    ...
    const CurrentTripView: React.FC = () => {
        ...
        type StoreGroup = { storeId: string; storeName: string; address: string; orders: RouteStop[] };
        ...
        const currentStoreGroupIndex = useMemo(() => sequencedStoreGroups.findIndex(group => group.orders.some(o => o.status === 'Pending')), [sequencedStoreGroups]);
        ...
        return (
            <div className="p-4 space-y-4">
                ...
                <details className="bg-white rounded-lg shadow p-2">
                    <summary className="font-semibold text-brand-primary cursor-pointer">Lihat Peta Rute</summary>
                    <div className="mt-2">
                ...
                <div className="space-y-4">
                    {sequencedStoreGroups.map((storeGroup, groupIndex) => {
                        ...
                        const prevLocation = groupIndex === 0 ? depotLocation : sequencedStoreGroups[groupIndex - 1].orders[0].location;
                        const distance = getDistance(prevLocation, storeGroup.orders[0].location);
