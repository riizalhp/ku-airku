...
export const AdminView: React.FC = () => {
    ...
    return (
        <div className="flex h-screen bg-brand-background">
             {/* Desktop Sidebar */}
            <aside className="hidden md:flex w-64 bg-brand-dark text-white flex-col flex-shrink-0">
                {sidebarContent}
            </aside>
            ...
            <aside className={`md:hidden fixed top-0 left-0 h-full w-64 bg-brand-dark text-white flex flex-col z-40 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                {sidebarContent}
            </aside>
